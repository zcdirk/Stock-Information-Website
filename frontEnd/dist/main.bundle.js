...
var EXPORT_URL = 'http://zcstock.us-east-1.elasticbeanstalk.com/export/';
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.shareOnFacebook = function () {
        ...
        this.http.post('http://export.highcharts.com/', data).subscribe(function (res) {
            var path = res["_body"];
    ...
    AppComponent.prototype.addToFavorite = function () {
        ...
        this.favoriteList = favorites;
        var str = JSON.stringify(favorites);
